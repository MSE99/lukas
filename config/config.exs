...
config :lukas, Lukas.Mailer, adapter: Swoosh.Adapters.Local
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js --bundle --splitting --format=esm --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
