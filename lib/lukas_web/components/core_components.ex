defmodule LukasWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-primary hover:bg-green-500 py-2 px-3 transition-all",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LukasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LukasWeb.Gettext, "errors", msg, opts)
    end
  end
