defmodule LukasWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule LukasWeb.PageLive do
        use LukasWeb, :live_view

        on_mount {LukasWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{LukasWeb.UserAuth, :ensure_authenticated}] do
